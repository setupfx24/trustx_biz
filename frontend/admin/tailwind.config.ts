  ...
  theme: {
    extend: {
      colors: {
        ...
        /* Trustx gold accent — matches trader */
        buy: {
          DEFAULT: "#035eeb",
          light: "#0394fa",
          dark: "#0943c0",
          bg: "rgba(3, 94, 235,0.08)",
          glow: "rgba(3, 94, 235,0.25)",
        },
        sell: {
          DEFAULT: "#ef4444",
          light: "#ff6b6b",
      ...
      keyframes: {
        ...
        glowPulse: {
          "0%,100%": { boxShadow: "0 0 8px rgba(3, 94, 235,0.15)" },
          "50%": { boxShadow: "0 0 20px rgba(3, 94, 235,0.3)" },
        },
        shimmer: {
      ...
      boxShadow: {
        ...
        "glow-green":
          "0 0 20px rgba(3, 94, 235,0.2), 0 0 60px rgba(3, 94, 235,0.08)",
        "neon-sm":
          "0 0 6px rgba(125,194,79,0.15), 0 0 12px rgba(3, 94, 235,0.08)",
      },
      backdropBlur: {
        glass: "16px",
        "glass-heavy": "24px",
