...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Approvals', href: '/approvals', icon: ShieldCheck, perm: 'audit_logs.view' },
...
export default function AdminSidebar() {
  ...
  return (
    <div className={cn(
      ...
      {/* Header */}
      <div className="flex items-center h-16 px-3 border-b border-border-primary/40">
        {collapsed ? (
          <img src="/images/feb.png" alt="Trustx" className="w-10 h-10 object-contain mx-auto" />
        ) : (
          <Link href="/" className="flex items-center min-w-0">
            <img src="/images/trustx_png5.png" alt="Trustx" className="h-14 w-auto object-contain shrink-0" />
          </Link>
        )}
        <button
