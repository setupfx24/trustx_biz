  ...
  return (
    <DashboardShell>
      <div className="page-main max-w-6xl mx-auto w-full pb-8">
        <Link
          href="/academy"
          className="inline-flex items-center gap-1.5 text-sm text-text-secondary hover:text-[#035eeb] transition-colors mb-5"
        >
          <ArrowLeft size={14} />
          ALL PHASES
        </Link>
                ...
                <span
                  className={clsx(
                    ...
                    phase.level === 'BEGINNER'
                      ? 'bg-[#035eeb]/10 text-[#035eeb] border-[#035eeb]/20'
                  ...
                  <div key={module.id}>
                    <Link
                      ...
                      className={clsx(
                        ...
                        isDone
                          ? 'bg-[#035eeb]/5 border-[#035eeb]/20 hover:border-[#035eeb]/40'
                    ...
                    >
                      <div
                        className={clsx(
                          ...
                          isDone ? 'bg-[#035eeb]/10 border-[#035eeb] text-[#035eeb]' : 'border-border-secondary text-text-tertiary',
                        )}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {isDone && (
                            <span className="text-[9px] px-1.5 py-0.5 rounded bg-[#035eeb]/10 text-[#035eeb] font-bold border border-[#035eeb]/20 uppercase tracking-wider">
                              DONE
                            </span>
                          )}
                        </div>
                      ...
                      <ArrowRight size={16} className="text-text-tertiary group-hover:text-[#035eeb] transition-colors shrink-0" />
                    </Link>
        ...
        {phase.quiz && phase.modules.length > 0 && (
          <div className="mt-6 bg-bg-secondary border border-[#035eeb]/20 rounded-xl p-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <p className="text-[10px] uppercase tracking-widest text-[#035eeb] font-medium mb-1">KNOWLEDGE CHECK</p>
                ...
                <div className="flex items-center gap-3 mt-2">
                  <div className="w-32 h-1.5 bg-bg-tertiary rounded-full overflow-hidden">
                    <div className="h-full bg-[#035eeb] rounded-full" style={{ width: '0%' }} />
                  </div>
              ...
              <Link
                ...
                className="px-4 py-2 rounded-lg bg-[#035eeb] hover:bg-[#0943c0] text-white text-sm font-semibold transition-colors text-center whitespace-nowrap"
              >
                Start Quiz
              </Link>
            </div>
