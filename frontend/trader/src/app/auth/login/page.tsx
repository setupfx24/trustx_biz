          ...
          <div className="auth-card">
            ...
            >
              ...
              <div className="auth-left__content">
                {cfg.title && <motion.h1 className="auth-left__title" {...fadeUp(0.3)}>{cfg.title}</motion.h1>}
                {cfg.subtitle && <motion.p className="auth-left__subtitle" {...fadeUp(0.4)}>{cfg.subtitle}</motion.p>}
