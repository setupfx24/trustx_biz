...
export default function ProfilePage() {
  ...
  const displayEmail = isDemo ? 'demo@trustx.biz' : (profile?.email ?? '');
          ...
          <section className="relative overflow-hidden rounded-xl border border-border-primary bg-card">
            ...
            <div className="relative z-10 px-4 sm:px-6 py-5 sm:py-7">
              ...
              <p className="text-sm text-text-secondary mt-1 max-w-2xl">
                Profile, security, notifications, and active sessions — aligned with trustx.
              </p>
            </div>
          </section>
                ...
                {TABS.map((t) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {active ? (
                        <span className="relative inline-block animate-wallet-main-tab-text drop-shadow-[0_0_16px_rgba(3, 94, 235,0.6)] truncate">
                          {t.label}
                        </span>
                      ) : (
                          ...
                          <div className="w-full h-20 rounded-lg mb-3 overflow-hidden" style={{ background: '#0a0a0a', border: '1px solid #2a2a2a' }}>
                            ...
                            <div className="flex h-[calc(100%-12px)]">
                              ...
                              <div className="flex-1 p-1.5">
                                <div className="h-1.5 w-3/4 rounded-full mb-1" style={{ background: '#035eeb' }} />
