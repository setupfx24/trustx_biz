...
export const metadata = { title: 'About Us — Trustx' }
      ...
      <section className="bg-gradient-to-b from-white to-gray-50 pt-16 pb-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Trustx is a decentralized exchange paired with a regulated broker — combining on-chain insured trades, non-custodial wallets, institutional-grade tools, and transparent pricing for complete financial freedom.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            <p className="text-gray-500 leading-relaxed">
              Trustx was founded with a simple belief: trading should be accessible, transparent, and fair for everyone. We saw traders struggling with high fees, slow withdrawals, and limited access to global markets. We decided to change that.
            </p>
            <p className="text-gray-500 leading-relaxed">
              Today, Trustx serves thousands of traders across 150+ countries, providing them with the tools and freedom they deserve. We're not just a broker—we're a movement toward financial independence.
            </p>
            <p className="text-gray-500 leading-relaxed">
