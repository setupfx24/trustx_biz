...
export const metadata = { title: 'Contact Us — Trustx' }
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              { icon: Mail, title: 'Email', value: 'info@trustx.biz', desc: 'Response within 1 hour' },
            ...
            {[
              {
                ...
                address: 'Trustx Office 23US, 18 Young St, UNIT LGE 1/1, Edinburgh EH2 4JB, Scotland',
