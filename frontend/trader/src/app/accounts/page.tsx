...
export default function AccountsPage() {
  ...
  const newAccountCtaClass =
    'inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg border-2 border-[#035eeb] text-[#035eeb] text-sm font-bold hover:bg-[#035eeb]/10 transition-colors shrink-0';
        ...
        <div className="space-y-4 p-1">
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 pt-3 border-t border-border-primary">
            ...
            <Link
              href="/kyc"
              onClick={() => setKycGateOpen(false)}
              className="px-5 py-2.5 rounded-lg bg-[#035eeb] text-white text-sm font-bold hover:bg-[#0943c0] transition-colors text-center"
            >
              Complete KYC
            </Link>
          </div>
              ...
              {liveAccounts.length === 0 ? (
                <div className="rounded-xl border border-dashed border-border-secondary bg-bg-base px-5 py-10 text-center">
                  ...
                  {!user?.is_demo && (
                    <button
                      ...
                      className="text-sm font-bold text-[#035eeb] hover:underline"
                    >
                      Open live account
                    </button>
                  )}
                ...
                <div className="space-y-4">
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="rounded-xl border border-accent/35 bg-bg-base p-4 flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-[#035eeb]/12 flex items-center justify-center text-[#035eeb] shrink-0">
                  ...
                  <div className="pt-3 space-y-2 border-t border-border-primary">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        className="text-sm font-bold text-[#035eeb] hover:underline disabled:opacity-40 disabled:pointer-events-none"
                      >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl bg-[#035eeb] text-white text-base font-bold hover:bg-[#0943c0] disabled:opacity-45 disabled:pointer-events-none transition-colors flex items-center justify-center gap-2"
                  >
      ...
      <div className="rounded-xl bg-bg-base border border-border-primary relative overflow-hidden" style={{ minHeight: '140px', maxHeight: '220px', aspectRatio: `${W}/${H + 10}` }}>
        {loading ? (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="h-5 w-5 border-2 border-[#035eeb] border-t-transparent rounded-full animate-spin" />
          </div>
        ) : (
      ...
      >
        <span
          className={clsx(
            ...
            row.is_demo ? 'bg-sky-400 shadow-[0_0_6px_rgba(56,189,248,0.7)]' : 'bg-[#035eeb] shadow-[0_0_6px_rgba(3, 94, 235,0.7)]',
          )}
          aria-hidden
        />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-4 sm:gap-x-6 gap-y-2 sm:gap-y-3">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-1">
                <span className={clsx('text-sm sm:text-lg font-bold tabular-nums font-mono truncate', pnlPositive ? 'text-[#035eeb]' : 'text-red-400')}>
              ...
              <p className={clsx('text-[10px] sm:text-xs font-semibold tabular-nums', pnlPositive ? 'text-[#035eeb]/70' : 'text-red-400/70')}>
            ...
            {isManagedAccount ? (
              <>
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-[#035eeb] text-white text-sm font-bold hover:bg-[#0943c0] transition-colors"
                >
                  <BookOpen size={16} />
                  View Trades
                </Link>
              ...
              <>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={(e) => { e.stopPropagation(); onTradePrepare(); }}
                  className="inline-flex items-center justify-center gap-1.5 px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg bg-[#035eeb] text-white text-xs sm:text-sm font-bold hover:bg-[#0943c0] transition-colors"
                >
                  Trade
