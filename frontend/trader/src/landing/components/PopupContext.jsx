              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white">
                      Get Started with Trustx
                    </h2>
                  </div>
                </div>
                <p className="text-text-secondary mb-6">
                  Fill in your details and our team will get you trading in
                  minutes.
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      <option value="" className="bg-primary-bg">
                        Select account type
                      </option>
                      <option value="demo" className="bg-primary-bg">
                        Demo Account
                      </option>
                      <option value="standard" className="bg-primary-bg">
                        Standard Account
                      </option>
                      <option value="pro" className="bg-primary-bg">
                        Pro Account
                      </option>
                    </select>
                  </div>
