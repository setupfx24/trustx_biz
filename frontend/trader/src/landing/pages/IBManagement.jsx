...
const benefits = [
  {
    ...
    desc: "Earn up to $12 per lot with our tiered rebate structure. The more clients you refer, the higher your earnings.",
  },
  {
    icon: Users,
    title: "Multi-Level Referrals",
    desc: "Earn from sub-IBs under your network. Build a team and generate passive income from multiple levels.",
  },
  {
    icon: BarChart2,
    title: "Real-Time Dashboard",
    desc: "Track referrals, commissions, client activity, and payouts in real time through your dedicated IB portal.",
  },
  {
    icon: Globe,
    title: "Marketing Materials",
    desc: "Access banners, landing pages, tracking links, and promotional content to grow your client base.",
  },
  {
    icon: Award,
    title: "Performance Bonuses",
    desc: "Unlock bonus tiers based on monthly volume. Top-performing IBs receive additional rewards and incentives.",
  },
  {
    icon: Headphones,
    title: "Dedicated IB Manager",
    desc: "Get a personal account manager to help you optimize your strategy, resolve issues, and scale your business.",
  },
];
        ...
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto mb-8">
              Partner with Trustx and earn competitive commissions by
              introducing new clients. Build your brokerage business with our
              support.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/company/contact">
                <Button variant="primary">Become an IB</Button>
              </Link>
        ...
        <div className="container-custom">
          <ScrollReveal variant="fadeUp">
            ...
            <p className="text-text-secondary text-center max-w-2xl mx-auto mb-12">
              Everything you need to build a successful introducing broker
              business.
            </p>
          </ScrollReveal>
            ...
            {tiers.map((t) => (
              <ScrollRevealItem key={t.name}>
                <div className={`glass-card p-6 text-center ${t.border}`}>
                  <h3 className={`${t.color} font-bold text-xl mb-2`}>
                    {t.name}
                  </h3>
            ...
            {[
              {
                step: "01",
                title: "Apply",
                desc: "Fill out the IB application form with your details.",
              },
              {
                step: "02",
                title: "Get Approved",
              ...
              },
              {
                ...
                desc: "Use your unique referral link to invite clients.",
              },
              {
                step: "04",
              ...
              <ScrollReveal variant="fadeRight" delay={0.2}>
                <div className="text-center">
                  ...
                  <p className="text-text-secondary mb-6">
                    No caps on commissions. The more clients you bring, the more
