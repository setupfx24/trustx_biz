...
const Home = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Easy Deposits",
      description:
        "Fund your account via card, bank wire, or crypto instantly.",
    },
    {
      icon: Globe,
      ...
      <section className="section-padding bg-primary-secondary">
        <div className="container-custom">
          ...
          <div className="text-center">
            <Link
              to="/company/why-trustx"
              className="inline-flex items-center gap-2 text-primary-accent hover:text-white transition-colors font-semibold text-lg"
            >
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500 max-w-3xl mx-auto">
              Choose your preferred platform — from industry-standard MetaTrader
              to our sleek Web Platform.
            </p>
          </div>
