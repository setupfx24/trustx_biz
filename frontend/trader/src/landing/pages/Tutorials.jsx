  ...
  const courses = [
    {
      ...
      description:
        "Learn the fundamentals of forex trading from scratch. Perfect for complete beginners.",
      duration: "2 hours",
      level: "Beginner",
      lessons: 12,
      icon: "📚",
    },
    {
      ...
      description:
        "Master chart patterns, indicators, and technical analysis strategies used by professionals.",
      duration: "4 hours",
      level: "Intermediate",
      lessons: 20,
      icon: "📊",
    },
    {
      ...
      description:
        "Develop the mental discipline and risk management skills essential for trading success.",
      duration: "3 hours",
      level: "Intermediate",
      lessons: 15,
      icon: "🧠",
    },
    {
      ...
      description:
        "Learn to set up automated strategies and copy trading on trustx.",
      duration: "5 hours",
      level: "Advanced",
      lessons: 25,
      icon: "🤖",
        ...
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Learn at your own pace with our comprehensive video courses and
              tutorials.
            </p>
          </ScrollReveal>
        </div>
            ...
            <div className="glass-card p-12 text-center max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    Apply what you learn immediately in your trading
                  </p>
                </div>
              </div>
