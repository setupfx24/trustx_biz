              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-text-secondary leading-relaxed mb-6">
                    Trustx offers a fully Shariah-compliant trading account
                    designed for traders who require swap-free trading.
                  </p>
                ...
                <div className="flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 rounded-lg bg-primary-purple/10 text-primary-purple flex items-center justify-center mx-auto mb-4">
                      <Moon size={36} />
                    </div>
