    ...
    <ScrollReveal variant="fadeUp" delay={index * 0.08}>
      <div
        className={`border rounded-xl overflow-hidden transition-all duration-300 cursor-pointer ${
          open
            ? "border-primary-accent/30 bg-primary-accent/[0.04]"
            : "border-white/[0.06] bg-[#111827] hover:border-white/10"
        }`}
      ...
      >
        <div className="flex items-center justify-between p-5">
          ...
          <span
            className={`flex-shrink-0 transition-transform duration-300 ${open ? "text-primary-accent rotate-180" : "text-text-secondary"}`}
          >
            <ChevronDown size={18} />
          </span>
        </div>
      ...
      <section className="section-padding bg-primary-secondary relative overflow-hidden">
        <div className="container-custom relative z-10">
          <SectionHeader
            ...
            subtitle="Find answers to the most common questions about trading with trustx."
          />
        ...
        <div className="container-custom relative z-10 text-center">
          <ScrollReveal variant="fadeUp">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-accent/10 border border-primary-accent/20 mb-6">
              ...
              <span className="text-primary-accent text-xs font-semibold uppercase tracking-widest">
                Start Trading Today
              </span>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal variant="fadeIn" delay={0.2}>
            <p className="text-text-secondary text-lg mb-8 max-w-xl mx-auto">
              Join thousands of traders who trust Trustx for professional-grade
              execution, transparent pricing, and competitive conditions.
            </p>
          </ScrollReveal>
          <ScrollReveal variant="fadeUp" delay={0.3}>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                to="/accounts/demo"
                className="btn-outline gap-2 text-base px-8 py-3.5"
              >
          ...
          <div className="flex items-center justify-center gap-3 mt-12 opacity-30">
            ...
            <div className="text-primary-accent text-sm font-semibold">
              Trustx
            </div>
            <div className="w-16 h-px bg-primary-accent" />
          </div>
