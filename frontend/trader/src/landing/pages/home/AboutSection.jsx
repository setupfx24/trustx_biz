        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative rounded-lg overflow-hidden aspect-square w-full max-w-md mx-auto border border-white/[0.08]">
                ...
                <div className="absolute top-6 left-6 rounded-md p-3 border border-primary-accent/20 bg-[#111827]/90">
                  <div className="text-primary-accent text-xs font-semibold uppercase tracking-wider">
                    Our Vision
                  </div>
                ...
                <div className="absolute bottom-6 right-6 rounded-md p-3 border border-primary-purple/20 bg-[#111827]/90">
                  <div className="text-primary-purple text-xs font-semibold uppercase tracking-wider">
                    Our Mission
                  </div>
                  <div className="text-white text-xs mt-1">
                    Empower traders worldwide
                  </div>
                </div>

                <div className="absolute bottom-6 left-6 rounded-md p-3 border border-white/10 bg-[#111827]/90">
                  <div className="text-text-secondary text-xs font-semibold mb-1.5 uppercase tracking-wider">
                    Core Values
                  </div>
                  {[
                    "Transparency",
                    ...
                    <div
                      key={val}
                      className="text-white text-xs flex items-center gap-1.5 mb-0.5"
                    >
          ...
          <ScrollReveal variant="fadeRight" delay={0.2}>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-4">
              BUILT ON <span className="gradient-text">PRECISION & TRUST</span>
            </h2>

            <div
              className="w-16 h-px mb-6"
              style={{
                background: "linear-gradient(90deg, #1A56FF, transparent)",
              }}
            />

            <div className="space-y-4 mb-8">
              <p className="text-text-secondary leading-relaxed">
                Trustx was founded with a clear vision — to give traders around
                the world access to professional-grade trading infrastructure,
                transparent pricing, and reliable support.
              </p>
              <p className="text-text-secondary leading-relaxed">
                Our platform combines advanced technology with deep liquidity to
                deliver a seamless trading experience powered by global
                financial expertise.
              </p>
              <p className="text-text-secondary leading-relaxed">
                From beginners entering financial markets to professional
                algorithmic traders, Trustx provides the tools, speed, and
                reliability needed to trade with confidence in global markets.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mb-8">
              {pillars.map((p) => (
                ...
                >
                  <div className="text-primary-accent mb-2 flex justify-center">
                    {p.icon}
                  </div>
                  <div className="text-text-secondary text-xs group-hover:text-white transition-colors">
                    {p.label}
                  </div>
                </div>
              ))}
