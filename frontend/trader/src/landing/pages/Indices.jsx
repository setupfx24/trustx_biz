...
const Indices = () => {
  const data = {
    ...
    subtitle:
      "Get exposure to US500, UK100, GER40 and more with low margin requirements.",
    stats: [
    ...
    instruments: [
      ...
      {
        symbol: "JPN225 (Nikkei)",
        spread: "1.0 pips",
        leverage: "1:200",
        margin: "0.5%",
      },
      {
        symbol: "AUS200 (ASX 200)",
        spread: "1.0 pips",
        leverage: "1:200",
        margin: "0.5%",
      },
    ...
    benefits: [
      {
        ...
        description:
          "Trade major indices from the US, Europe, Asia, and Australia all from one platform.",
      },
      {
        icon: "📈",
        title: "Low Margin Requirements",
        description:
          "Access large market positions with competitive margin rates and flexible leverage up to 1:200.",
      },
      {
        icon: "⏰",
        title: "Extended Trading Hours",
        description:
          "Trade indices nearly 24/7 with access to both cash and futures contracts.",
      },
    ],
  };
