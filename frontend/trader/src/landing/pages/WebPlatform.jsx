  ...
  const features = [
    {
      ...
      description:
        "No downloads required. Access your account from any device with a web browser.",
    },
    {
      icon: BarChart3,
      title: "TradingView Integration",
      description:
        "Full TradingView chart integration with 100+ indicators and drawing tools.",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Set price alerts and get instant notifications on market movements.",
    },
  ];
        ...
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Trustx Web Platform — Trade Instantly, Anywhere
            </h1>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto mb-8">
              No download required. Launch the platform from any browser and
            ...
            <ScrollReveal variant="fadeLeft">
              <div>
                ...
                <p className="text-text-secondary text-lg mb-8">
                  Our web platform combines powerful features with an intuitive
                  interface. Whether you're a beginner or experienced trader,
              ...
              <div className="glass-card overflow-hidden">
                <div className="aspect-video rounded-t-lg overflow-hidden">
                  <img
                    ...
                    alt="Trustx Web Platform"
                    className="w-full h-full object-contain p-16 bg-gradient-to-br from-primary-bg to-primary-secondary"
                  />
                </div>
                <div className="p-8">
                  ...
                  <p className="text-text-secondary mb-6">
                    Trade from your desktop, laptop, tablet, or smartphone. Your
        ...
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            ...
            <p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
              No downloads, no installations. Just open your browser and start
              trading.
            </p>
            <Link to="/accounts/demo">
