      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2 shrink-0">
            ...
            <img src="/images/trustx_png.png" alt="Trustx" className="h-9 sm:h-10 w-auto object-contain" />
            <span className="font-bold italic tracking-tight text-lg select-none">
              <span className="text-gray-800">Swis</span><span className="text-[#035eeb]">Dex</span>
            </span>
          </Link>
