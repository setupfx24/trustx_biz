      ...
      <div className="relative" style={{ width: size, height: size }}>
        <svg width={size} height={size} className="rotate-[-90deg]">
          ...
          <circle
            ...
            className="drop-shadow-[0_0_6px_rgba(3, 94, 235,0.45)]"
          />
        </svg>
  ...
  return (
    <section className="text-text-primary">
      <div className="flex items-center gap-2 mb-4">
        <div className="w-10 h-10 rounded-xl bg-[#035eeb]/12 border border-[#035eeb]/25 flex items-center justify-center">
          <BookOpen className="w-5 h-5 text-[#035eeb]" />
        </div>
          ...
          <div className="flex items-start justify-between gap-2">
            <div>
              <p className="text-[10px] font-bold text-text-tertiary uppercase tracking-wider flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#035eeb]" />
                Balance
              </p>
            ...
            <div className="w-10 h-10 rounded-full bg-bg-secondary border border-border-primary flex items-center justify-center">
              <Wallet className="w-5 h-5 text-[#035eeb]" />
            </div>
          </div>
        </div>
        <div className="rounded-xl p-4 border relative overflow-hidden" style={{ backgroundColor: CARD, borderColor: BORDER }}>
          <div className="flex items-start justify-between gap-2">
            <div>
              ...
              {(j.credit || 0) > 0 && (
                <p className="text-[11px] text-amber-400/80 font-medium tabular-nums mt-1">
                  incl. {fmtUsd(j.credit || 0)} credit (bonus / insurance)
                </p>
              )}
            </div>
            <div className="w-10 h-10 rounded-full bg-bg-secondary border border-border-primary flex items-center justify-center">
              <DollarSign className="w-5 h-5 text-[#035eeb]" />
            </div>
          </div>
        </div>
      </div>
        ...
        {[
          {
            ...
            valueClass: j.netPl >= 0 ? 'text-[#035eeb]' : 'text-red-400',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
        ...
        <div className="rounded-xl p-4 border" style={{ backgroundColor: CARD, borderColor: BORDER }}>
          <div className="flex items-center gap-2 text-sm font-semibold text-text-primary mb-3">
            <PieChart className="w-4 h-4 text-[#035eeb]" />
            Account stats
          </div>
