          ...
          <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
            <span
              className={clsx(
                ...
                pos.side === 'buy' ? 'bg-[#035eeb]/18 text-[#035eeb]' : 'bg-[#ff5252]/18 text-[#ff5252]',
              )}
            >
              {pos.side}
            </span>
        ...
        <div className="text-right shrink-0">
          <div
            className={clsx(
              ...
              pnl >= 0
                ? 'bg-green-500/10 border-green-500/20 text-[#035eeb]'
          ...
          <div className="text-[11px] font-mono font-semibold tabular-nums inline-flex items-center justify-end gap-0.5 text-text-primary leading-tight">
            ...
            {cur != null &&
              (priceDown ? (
                ...
                <TrendingUp className="w-3 h-3 text-[#035eeb]" aria-hidden />
              ))}
          </div>
        </div>
      </div>
                    ...
                    <div className="flex flex-col items-end gap-0.5 shrink-0">
                      ...
                      <span
                        className={clsx(
                          ...
                          totalPnl >= 0 ? 'text-[#035eeb]' : 'text-[#ef5350]',
                        )}
                      >
                ...
                {tabs.map((tab) => (
                  <button
                    ...
                    className={clsx(
                      ...
                      activeTab === tab.id
                        ? clsx('text-text-primary border-[#035eeb]', 'bg-bg-secondary/70')
                        : clsx(
