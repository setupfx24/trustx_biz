      ...
      <div className="relative h-full flex flex-col p-6 md:p-8">
        ...
        <div className="flex justify-center pt-2 pb-3">
          <div className="inline-flex items-center gap-1.5">
            ...
            <span className="text-white text-[10px] font-bold tracking-[0.25em]">Trustx</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center gap-4">
          ...
          <div className="flex items-center justify-center gap-2 flex-wrap">
            <span
              className={`px-3 py-1 rounded-md text-xs font-bold uppercase ${isBuy ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/40' : 'bg-red-500/20 text-red-400 border border-red-500/40'
                }`}
            >
              {side}
            </span>
