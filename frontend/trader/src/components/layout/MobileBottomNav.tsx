...
const SHEET_ITEMS: { name: string; path: string; color: string; icon: LucideIcon }[] = [
  { name: 'Deposit', path: '/wallet', color: '#035eeb', icon: ArrowDownToLine },
    ...
    <>
      ...
      >
        <div className="relative bg-bg-base">
          {/* Top border glow */}
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#035eeb]/20 to-transparent" />
          ...
          <div className="flex items-end justify-around h-[62px] px-1">
            ...
            >
              <div className={clsx(
                ...
                isChart
                  ? 'bg-accent text-text-inverse shadow-[0_4px_20px_rgba(3, 94, 235,0.4)]'
