...
CREATE TABLE deposits (
    ...
    method VARCHAR(30) CHECK (method IN ('bank_transfer', 'upi', 'qr', 'crypto_btc', 'crypto_eth', 'crypto_usdt', 'metamask', 'oxapay', 'nowpayments', 'manual')),
...
-- Seed super admin (password: trustxAdmin2025! — change in production)
INSERT INTO users (email, password_hash, first_name, last_name, role, status, kyc_status)
VALUES ('admin@trustx.biz', '$2b$12$OV1PUf7jA8E22RQ184o0n.KkEjbSriZbLaDqO4SJGj/bjleK37Zh2', 'Super', 'Admin', 'super_admin', 'active', 'approved');
